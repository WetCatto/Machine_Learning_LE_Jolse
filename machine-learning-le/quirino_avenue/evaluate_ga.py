"""
Evaluate GA-optimised vs baseline fixed-time plan for E. Quirino Avenue.
...
try:
    ...
    print("scipy not found — t-test p-values will not be computed. "
          "Install scipy for statistical output.")
...
def evaluate():
    ...
    print("=" * 60)
    print("E. Quirino Avenue — GA vs Baseline Evaluation")
    print("=" * 60)
    ...
    # --- GA-optimised trials (same seeds) ---
    ...
    def _pct_change(base, new):
        ...
        if m_base == 0:
            return 0.0
        return (m_new - m_base) / m_base * 100.0
